...
public static class WorldEvents
{
    ...
    public static bool AskedOppositaAboutGallery = false;
    ...
    public static bool HasTeaLeaves = false;
    public static bool OppositaIsCrying = false;
    public static bool OppositaRevealedScissors = false;
    public static bool SpokeToAy = true;
    public static bool SpokeToMrB = true;
